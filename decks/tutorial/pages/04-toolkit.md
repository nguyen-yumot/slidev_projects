...
Inline emphasis with a Carbon icon and a label. Four semantic types — plus `blank` for an aside that doesn't fit a category.

<div class="grid grid-cols-2 gap-3 pt-3">

<Callout type="tip">Keep slides to one idea each.</Callout>

<Callout type="warning">This step needs a dependency.</Callout>

<Callout type="note">Speaker view lives at <code>/presenter</code>.</Callout>

<Callout type="try">Press <KeyCap>o</KeyCap> right now.</Callout>

</div>

<div class="pt-2">

<Callout type="blank">No icon, no label — just a neutral rail for a highlight that isn't tip, warning, note, or try.</Callout>

</div>

```md
<Callout type="tip">Keep slides to one idea.</Callout>
<Callout type="warning" title="Heads up">Optional custom title.</Callout>
<Callout type="blank">Neutral highlight, no label.</Callout>
```
